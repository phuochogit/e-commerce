        ...
        <div>
            ...
            >
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div>
                        <Button className='pb-5' variant='h6' gutterBottom>Career</Button>
                    </div>

                    <div>
                        <Button className='pb-5' variant='h6' gutterBottom>Zalo</Button>
                    </div>

                    <div>
                        <Button className='pb-5' variant='h6' gutterBottom>Email</Button>
                    </div>
                ...
                <Grid className='pt-20' item xs={12} >
                    <Typography variant="body2" component="p" align="center"> &copy; 2024 My Company. All rights reserved.
                    </Typography>
                    ...
                    <Typography variant="body2" component="p" align="center"> Icons made by{' '}
                        ...
                        from {' '}
                        <Link
                            href="https://www.flaticon.com/" color="inherit" underline="always">
                            www.flaticon.com
                        </Link>
                    </Typography>
                </Grid>
